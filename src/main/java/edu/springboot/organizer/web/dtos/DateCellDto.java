...
public class DateCellDto extends BaseDto {
    ...
    @Builder
    public DateCellDto(String created, Integer hashId, Integer day, Integer hours, Integer beginHour, Integer endHour, String monthRecordId) {
