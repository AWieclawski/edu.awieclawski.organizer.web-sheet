...
import edu.springboot.organizer.rest.dtos.EmployeeDto;
import edu.springboot.organizer.rest.dtos.UserDto;
import edu.springboot.organizer.generator.enums.CellType;
import edu.springboot.organizer.rest.services.CredentialService;
import edu.springboot.organizer.rest.services.DateCellService;
import edu.springboot.organizer.rest.services.EmployeeService;
import edu.springboot.organizer.rest.services.MonthRecordService;
import edu.springboot.organizer.rest.services.UserService;
import edu.springboot.organizer.rest.services.VisitorService;
...
public class DataStarter {
    ...
    private void operateDemoData() {
        ...
        UserDto user1 = userService.createUser(User.builder().id("userd01").name("Examplename1").surName("Examplesurname1").credentialId("examplecredentials1").build());
        UserDto user2 = userService.createUser(User.builder().id("userd02").name("Examplename2").surName("Examplesurname2").credentialId("examplecredentials2").build());
