...
import static edu.springboot.organizer.data.models.Visitor.TABLE_NAME;

@Repository(VisitorRepository.BEAN_NAME)
@RequiredArgsConstructor
public class VisitorRepository {

    public static final String BEAN_NAME = "repositories.data.edu.springboot.organizer.VisitorRepository";
