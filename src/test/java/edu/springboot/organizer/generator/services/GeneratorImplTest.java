...
class GeneratorImplTest {
    ...
    void dateCellsGenerate_withValidArgs_returnsOK() {
        ...
        recordsSetDto = RecordsSetDto.builder().month(2).year(2025).created("MONTH_ID").build();
        List<DateCellDto> list = inst.dateCellsGenerate(monthRecordDto, recordsSetDto.getMonth(), recordsSetDto.getYear());
        Assertions.assertNotNull(list);
        Assertions.assertEquals("01-02-2025", recordsSetDto.getLocalDate(list.get(0).getDay()));
    }
